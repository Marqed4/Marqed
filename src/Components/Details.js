  ...
  return (
    <div className = "details-container">
      ...
      <div className = "details-education-section">
        ...
        I pull inspiration from standout editors who bring culture, personality, and movement into gameplay and everyday moments. <br/> 
        For me, developing/editing is both expression and utility! <br/>
        I enjoy building projects that feel good to make and serve a purpose. <br/>
